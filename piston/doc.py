...
typemapper = __import__(name = settings.PROJECT_NAME + '.piston.handler', fromlist = ['typemapper', ])
handler_tracker = __import__(settings.PROJECT_NAME + '.piston.handler', fromlist = ['handler_tracker'])
