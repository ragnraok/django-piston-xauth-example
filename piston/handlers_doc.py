...
generate_doc = __import__(name = settings.PROJECT_NAME + '.piston.doc', fromlist = ['generate_doc',])
handler_tracker = __import__(name = settings.PROJECT_NAME + '.piston.handler', fromlist = ['handler_tracker'])
