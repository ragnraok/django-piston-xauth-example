...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('piston_consumer', 'xauth_allowed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Consumer.xauth_allowed'
        db.delete_column('piston_consumer', 'xauth_allowed')
    ...
    models = {
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1300379670L'}),
